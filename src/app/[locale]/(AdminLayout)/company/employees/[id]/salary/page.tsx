...
import { SalaryConfigContent } from "./_salary-config-content";
...
export default async function EmployeeSalaryPage({
  ...
  const t = await getTranslations("salaryConfig");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href={`/company/employees/${id}`} className="hover:opacity-70">
      ...
      {/* Content */}
      <SalaryConfigContent employeeId={Number(id)} />
    </div>
  );
}
