...
export function EmployeeDetail({ employee }: EmployeeDetailProps) {
  ...
  const handleViewAttendance = () =>
    router.push(`/${locale}/dashboard/employees/${employee.id}/attendance`);
  const handleViewPayroll = () =>
    router.push(`/${locale}/dashboard/employees/${employee.id}/payroll`);
  const handleViewSalary = () =>
    router.push(`/${locale}/dashboard/employees/${employee.id}/salary`);
