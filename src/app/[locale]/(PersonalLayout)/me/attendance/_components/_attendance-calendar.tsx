...
} from "@/app/[locale]/_components/_shared/attendance/_calendar-view";
...
export function AttendanceCalendar({
  ...
  const handleDateClick = (date: Date) => {
    ...
    router.push(`/${locale}/me/attendance/${dateStr}`);
  };
  ...
  return <GlassSection title={t("calendar")}>{calendarContent}</GlassSection>;
}
