...
/**
 * Nội dung trang Phản hồi khách hàng cho SupportLayout
 * Tương tự admin feedbacks nhưng dành cho nhân viên hỗ trợ
 */
export function FeedbacksPageContent() {
  ...
  useEffect(() => {
    fetchFeedbacks(); // eslint-disable-line react-hooks/set-state-in-effect
  }, [fetchFeedbacks]);
  ...
  // Click vào row -> chuyển đến trang detail trong support layout
  const handleRowClick = (feedback: Feedback) => {
    router.push(`/${locale}/support/feedbacks/${feedback.id}`);
  };
