...
import { LANGUAGES, LOCALES } from "@/types/enums";
import { useZipcode } from "@/hooks/use-zipcode";
import { ImageCropDialog } from "../image/_image-crop-dialog";
...
export function CompanyDetailCard({
  ...
  return (
    <div className="grid xl:grid-cols-2 gap-6 max-w-[1300px] mx-auto">
      {/* Profile Card */}
      <GlassCard className="p-4 flex-1 flex flex-col">
        ...
        <div className="grid gap-3 flex-1">
          ...
          <div>
            <Label className="text-xs">{t("form.locale")}</Label>
            <SelectWithIcon
          ...
          <div>
            <Label className="text-xs">{t("form.language")}</Label>
            <SelectWithIcon
              ...
              <SelectContent>
                {LANGUAGES.map((lang) => (
                  <SelectItem key={lang.value} value={lang.value}>
                    {lang.flag} {tEnums(`language.${lang.value}`)}
                  </SelectItem>
                ))}
              </SelectContent>
            </SelectWithIcon>
      ...
      <GlassCard className="p-4 flex flex-col">
        ...
        <div className="space-y-3 flex-1">
          ...
          {/* Ẩn nút xem gói dịch vụ cho Tamabee company (id=0) */}
          {company.id !== 0 && (
